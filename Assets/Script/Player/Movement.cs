...
public class Movement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PlayerStateManager.Instance.Setup(this);
    ...
    private void Update()
    {
        ...
        PlayerStateManager.Instance.SelectState(ref state); //Selects the state depending on which state the player is present in
    }
    private void FixedUpdate()
    {
        state?.Execute(); //Call the execute method to execute the necessary functions
    }
